...
// Tipos para Solicitudes de Compra (21 campos específicos)
...
// Solicitud de Compra principal con los 21 campos
export interface SolicitudCompra {
  ...
  // Relaciones (opcionales para cuando se cargan con JOIN)
