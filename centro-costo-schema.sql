-- Script para crear tabla de centros de costo y cargar datos del CSV
...
CREATE INDEX IF NOT EXISTS idx_centros_costo_empresa ON centros_costo(empresa);
CREATE INDEX IF NOT EXISTS idx_centros_costo_cliente ON centros_costo(cliente);
CREATE INDEX IF NOT EXISTS idx_centros_costo_activo ON centros_costo(activo);
...
ON CONFLICT (codigo) DO UPDATE SET
  ...
  centro_costo_anterior = EXCLUDED.centro_costo_anterior,
  nombre_anterior = EXCLUDED.nombre_anterior,
  activo = EXCLUDED.activo,
  tipo_proyecto = EXCLUDED.tipo_proyecto,
  clasificacion_comite = EXCLUDED.clasificacion_comite,
  updated_at = NOW();
